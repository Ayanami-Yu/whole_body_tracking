...
# Example: python scripts/csv_to_npz.py --input_file /home/hongyu/datasets/LAFAN1_Retargeting_Dataset/g1/walk1_subject1.csv --input_fps 30 --output_name walk1_subject1 --headless
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    # ------- data logger -------------------------------------------------------
    # The motion data to be uploaded to WandB
    log = {
