...
# Example: python scripts/rsl_rl/train.py --task=Tracking-Flat-G1-v0 --registry_name ayanami-yu-bigai-org/wandb-registry-motions/walk1_subject1 --headless --logger wandb
...
from whole_body_tracking.utils.custom import dump_pickle
