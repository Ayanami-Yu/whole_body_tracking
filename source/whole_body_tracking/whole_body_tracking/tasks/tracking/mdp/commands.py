...
class MotionLoader:
    def __init__(self, motion_file: str, body_indexes: Sequence[int], device: str = "cpu"):
        """Load reference motions from npz file."""
        ...
        # Reference body positions and orientations (in world coord)
...
class MotionCommand(CommandTerm):
    ...
    def _update_command(self):
        ...
        )  # Smooth failure rate over time using exponential moving average
